...
Recharging_Time_of_Lithium_Accu_NMC = model.constant("Recharging_Time_of_Lithium_Accu_NMC")
Recharging_Time_of_Lithium_Accu_NMC.equation = values["Recharging Time of Lithium Accu NMC"]

Recharging_Frequency_of_Lithium_Accu_NMC = model.constant("Recharging_Frequency_of_Lithium_Accu_NMC")
Recharging_Frequency_of_Lithium_Accu_NMC.equation = values["Recharging Frequency of Lithium Accu NMC"]

Recharging_Loss_Cost_of_Lithium_Accu_NMC = model.converter("Recharging_Loss_Cost_of_Lithium_Accu_NMC")
Recharging_Loss_Cost_of_Lithium_Accu_NMC.equation = Recharging_Time_of_Lithium_Accu_NMC * Recharging_Frequency_of_Lithium_Accu_NMC * Social_External_Cost

# -----------------------------------------------------------------------------

Maintenance_Frequency_of_Lithium_Accu_NMC = model.constant("Maintenance_Frequency_of_Lithium_Accu_NMC")
Maintenance_Frequency_of_Lithium_Accu_NMC.equation = values["Maintenance Frequency of Lithium Accu NMC"]

Maintenance_Time_of_Lithium_Accu_NMC = model.constant("Maintenance_Time_of_Lithium_Accu_NMC")
Maintenance_Time_of_Lithium_Accu_NMC.equation = values["Maintenance Time of Lithium Accu NMC"]

Maintenance_Loss_Cost_of_Lithium_Accu_NMC = model.converter("Maintenance_Loss_Cost_of_Lithium_Accu_NMC")
Maintenance_Loss_Cost_of_Lithium_Accu_NMC.equation = Maintenance_Frequency_of_Lithium_Accu_NMC * Maintenance_Time_of_Lithium_Accu_NMC * Social_External_Cost

# -----------------------------------------------------------------------------

Ni = model.constant("Ni")
Ni.equation = values["Ni"]

Average_Expected_Years_Kept_of_Lithium_Accu_NMC = model.constant("Average_Expected_Years_Kept_of_Lithium_Accu_NMC")
Average_Expected_Years_Kept_of_Lithium_Accu_NMC.equation = values["Average Expected Years Kept of Lithium Accu NMC"]

Ni_Annual_Emissions_Load_Lithium_Accu_NMC = model.converter("Ni_Annual_Emissions_Load_Lithium_Accu_NMC")
Ni_Annual_Emissions_Load_Lithium_Accu_NMC.equation = Ni / Average_Expected_Years_Kept_of_Lithium_Accu_NMC

CNi = model.constant("CNi")
CNi.equation = values["CNi"]

Health_Cost_of_Lithium_Accu_NMC = model.converter("Health_Cost_of_Lithium_Accu_NMC")
Health_Cost_of_Lithium_Accu_NMC.equation = Ni_Annual_Emissions_Load_Lithium_Accu_NMC * CNi

# -----------------------------------------------------------------------------

Social_Impact_Cost_of_Lithium_Accu_NMC = model.converter("Social_Impact_Cost_of_Lithium_Accu_NMC")
Social_Impact_Cost_of_Lithium_Accu_NMC.equation = (Recharging_Loss_Cost_of_Lithium_Accu_NMC + Maintenance_Loss_Cost_of_Lithium_Accu_NMC + Health_Cost_of_Lithium_Accu_NMC)

Maintenance_Price_of_Lithium_Accu_NMC = model.constant("Maintenance_Price_of_Lithium_Accu_NMC")
Maintenance_Price_of_Lithium_Accu_NMC.equation = values["Maintenance Price of Lithium Accu NMC"]

Maintenance_Cost_of_Lithium_Accu_NMC = model.converter("Maintenance_Cost_of_Lithium_Accu_NMC")
Maintenance_Cost_of_Lithium_Accu_NMC.equation = Maintenance_Frequency_of_Lithium_Accu_NMC * Maintenance_Price_of_Lithium_Accu_NMC

# -----------------------------------------------------------------------------

Capacity_of_Lithium_Accu_NMC = model.constant("Capacity_of_Lithium_Accu_NMC")
Capacity_of_Lithium_Accu_NMC.equation = values["Capacity of Lithium Accu NMC"]

Voltage_of_Lithium_Accu_NMC = model.constant("Voltage_of_Lithium_Accu_NMC")
Voltage_of_Lithium_Accu_NMC.equation = values["Voltage of Lithium Accu NMC"]

Charging_Efficiency_of_Lithium_Accu_NMC = model.constant("Charging_Efficiency_of_Lithium_Accu_NMC")
Charging_Efficiency_of_Lithium_Accu_NMC.equation = values["Charging Efficiency of Lithium Accu NMC"]

Energy_Consumption_of_Lithium_Accu_NMC = model.converter("Energy_Consumption_of_Lithium_Accu_NMC")
Energy_Consumption_of_Lithium_Accu_NMC.equation = (((Voltage_of_Lithium_Accu_NMC * Capacity_of_Lithium_Accu_NMC)/1000)/Charging_Efficiency_of_Lithium_Accu_NMC) * Electricity_Price * Recharging_Frequency_of_Lithium_Accu_NMC

Operational_Cost_of_Lithium_Accu_NMC = model.converter("Operational_Cost_of_Lithium_Accu_NMC")
Operational_Cost_of_Lithium_Accu_NMC.equation = Energy_Consumption_of_Lithium_Accu_NMC + Maintenance_Cost_of_Lithium_Accu_NMC

# -----------------------------------------------------------------------------

LiAPIncRate = model.constant("LiAPIncRate")
LiAPIncRate.equation = values["Lithium Accu NMC Price Increase Rate"]
LiAPInc = model.flow("LiAPInc")
Price_of_Lithium_Accu_NMC = model.stock("Price_of_Lithium_Accu_NMC")
Price_of_Lithium_Accu_NMC.initial_value = values["Initial NMC Price"]
Price_of_Lithium_Accu_NMC.equation = LiAPInc
LiAPInc.equation = Price_of_Lithium_Accu_NMC * LiAPIncRate

Depreciation_Rate_of_Lithium_Accu_NMC = model.constant("Depreciation_Rate_of_Lithium_Accu_NMC")
Depreciation_Rate_of_Lithium_Accu_NMC.equation = values["Depreciation Rate of Lithium Accu NMC"]

Resale_Value_of_Lithium_Accu_NMC = model.converter("Resale_Value_of_Lithium_Accu_NMC")
Resale_Value_of_Lithium_Accu_NMC._function_string = (
    "lambda model, t: ("
    "(pow(1.0 - model.memoize('Depreciation_Rate_of_Lithium_Accu_NMC', t), "
    "model.memoize('Average_Expected_Years_Kept_of_Lithium_Accu_NMC', t)) "
    "* model.memoize('Price_of_Lithium_Accu_NMC', t) "
    "* model.memoize('Real_Discount_Rate', t)) "
    "/ "
    "(pow(1.0 + model.memoize('Real_Discount_Rate', t), "
    "model.memoize('Average_Expected_Years_Kept_of_Lithium_Accu_NMC', t)) - 1.0)"
    ")"
)
Resale_Value_of_Lithium_Accu_NMC.generate_function()

Life_Cycle_Cost_of_Lithium_Accu_NMC = model.converter("Life_Cycle_Cost_of_Lithium_Accu_NMC")
Life_Cycle_Cost_of_Lithium_Accu_NMC.equation = (Price_of_Lithium_Accu_NMC/Average_Expected_Years_Kept_of_Lithium_Accu_NMC) + Operational_Cost_of_Lithium_Accu_NMC - Resale_Value_of_Lithium_Accu_NMC

# -----------------------------------------------------------------------------

Cost_Ownership_of_Lithium_Accu_NMC = model.converter("Cost_Ownership_of_Lithium_Accu_NMC")
Cost_Ownership_of_Lithium_Accu_NMC.equation = (Social_Impact_Cost_of_Lithium_Accu_NMC + Life_Cycle_Cost_of_Lithium_Accu_NMC)/1e+06

Recharging_Time_of_Lithium_Accu_LFP = model.constant("Recharging_Time_of_Lithium_Accu_LFP")
Recharging_Time_of_Lithium_Accu_LFP.equation = values["Recharging Time of Lithium Accu LFP"]

Recharging_Frequency_of_Lithium_Accu_LFP = model.constant("Recharging_Frequency_of_Lithium_Accu_LFP")
Recharging_Frequency_of_Lithium_Accu_LFP.equation = values["Recharging Frequency of Lithium Accu LFP"]

Recharging_Loss_Cost_of_Lithium_Accu_LFP = model.converter("Recharging_Loss_Cost_of_Lithium_Accu_LFP")
Recharging_Loss_Cost_of_Lithium_Accu_LFP.equation = Recharging_Time_of_Lithium_Accu_LFP * Recharging_Frequency_of_Lithium_Accu_LFP * Social_External_Cost

# -----------------------------------------------------------------------------

Maintenance_Frequency_of_Lithium_Accu_LFP = model.constant("Maintenance_Frequency_of_Lithium_Accu_LFP")
Maintenance_Frequency_of_Lithium_Accu_LFP.equation = values["Maintenance Frequency of Lithium Accu LFP"]

Maintenance_Time_of_Lithium_Accu_LFP = model.constant("Maintenance_Time_of_Lithium_Accu_LFP")
Maintenance_Time_of_Lithium_Accu_LFP.equation = values["Maintenance Time of Lithium Accu LFP"]

Maintenance_Loss_Cost_of_Lithium_Accu_LFP = model.converter("Maintenance_Loss_Cost_of_Lithium_Accu_LFP")
Maintenance_Loss_Cost_of_Lithium_Accu_LFP.equation = Maintenance_Frequency_of_Lithium_Accu_LFP * Maintenance_Time_of_Lithium_Accu_LFP * Social_External_Cost

# -----------------------------------------------------------------------------

Lfp = model.constant("Lfp")
Lfp.equation = values["Lfp"]

Average_Expected_Years_Kept_of_Lithium_Accu_LFP = model.constant("Average_Expected_Years_Kept_of_Lithium_Accu_LFP")
Average_Expected_Years_Kept_of_Lithium_Accu_LFP.equation = values["Average Expected Years Kept of Lithium Accu LFP"]

Lfp_Annual_Emissions_Load_Lithium_Accu_LFP = model.converter("Lfp_Annual_Emissions_Load_Lithium_Accu_LFP")
Lfp_Annual_Emissions_Load_Lithium_Accu_LFP.equation = Lfp / Average_Expected_Years_Kept_of_Lithium_Accu_LFP

Clfp = model.constant("Clfp")
Clfp.equation = values["Clfp"]

Health_Cost_of_Lithium_Accu_LFP = model.converter("Health_Cost_of_Lithium_Accu_LFP")
Health_Cost_of_Lithium_Accu_LFP.equation = Lfp_Annual_Emissions_Load_Lithium_Accu_LFP * CNi

# -----------------------------------------------------------------------------

Social_Impact_Cost_of_Lithium_Accu_LFP = model.converter("Social_Impact_Cost_of_Lithium_Accu_LFP")
Social_Impact_Cost_of_Lithium_Accu_LFP.equation = (Recharging_Loss_Cost_of_Lithium_Accu_LFP + Maintenance_Loss_Cost_of_Lithium_Accu_LFP + Health_Cost_of_Lithium_Accu_LFP)

Maintenance_Price_of_Lithium_Accu_LFP = model.constant("Maintenance_Price_of_Lithium_Accu_LFP")
Maintenance_Price_of_Lithium_Accu_LFP.equation = values["Maintenance Price of Lithium Accu LFP"]

Maintenance_Cost_of_Lithium_Accu_LFP = model.converter("Maintenance_Cost_of_Lithium_Accu_LFP")
Maintenance_Cost_of_Lithium_Accu_LFP.equation = Maintenance_Frequency_of_Lithium_Accu_LFP * Maintenance_Price_of_Lithium_Accu_LFP

# -----------------------------------------------------------------------------

Capacity_of_Lithium_Accu_LFP = model.constant("Capacity_of_Lithium_Accu_LFP")
Capacity_of_Lithium_Accu_LFP.equation = values["Capacity of Lithium Accu LFP"]

Voltage_of_Lithium_Accu_LFP = model.constant("Voltage_of_Lithium_Accu_LFP")
Voltage_of_Lithium_Accu_LFP.equation = values["Voltage of Lithium Accu LFP"]

Charging_Efficiency_of_Lithium_Accu_LFP = model.constant("Charging_Efficiency_of_Lithium_Accu_LFP")
Charging_Efficiency_of_Lithium_Accu_LFP.equation = values["Charging Efficiency of Lithium Accu LFP"]

Energy_Consumption_of_Lithium_Accu_LFP = model.converter("Energy_Consumption_of_Lithium_Accu_LFP")
Energy_Consumption_of_Lithium_Accu_LFP.equation = (((Voltage_of_Lithium_Accu_LFP * Capacity_of_Lithium_Accu_LFP)/1000)/Charging_Efficiency_of_Lithium_Accu_LFP) * Electricity_Price * Recharging_Frequency_of_Lithium_Accu_LFP

Operational_Cost_of_Lithium_Accu_LFP = model.converter("Operational_Cost_of_Lithium_Accu_LFP")
Operational_Cost_of_Lithium_Accu_LFP.equation = Energy_Consumption_of_Lithium_Accu_LFP + Maintenance_Cost_of_Lithium_Accu_LFP

# -----------------------------------------------------------------------------

LiAPIncRate = model.constant("LiAPIncRate")
LiAPIncRate.equation = values["Lithium Accu LFP Price Increase Rate"]
LiAPInc = model.flow("LiAPInc")
Price_of_Lithium_Accu_LFP = model.stock("Price_of_Lithium_Accu_LFP")
Price_of_Lithium_Accu_LFP.initial_value = values["Initial LFP Price"]
Price_of_Lithium_Accu_LFP.equation = LiAPInc
LiAPInc.equation = Price_of_Lithium_Accu_LFP * LiAPIncRate

Depreciation_Rate_of_Lithium_Accu_LFP = model.constant("Depreciation_Rate_of_Lithium_Accu_LFP")
Depreciation_Rate_of_Lithium_Accu_LFP.equation = values["Depreciation Rate of Lithium Accu LFP"]

Resale_Value_of_Lithium_Accu_LFP = model.converter("Resale_Value_of_Lithium_Accu_LFP")
Resale_Value_of_Lithium_Accu_LFP._function_string = (
    "lambda model, t: ("
    "(pow(1.0 - model.memoize('Depreciation_Rate_of_Lithium_Accu_LFP', t), "
    "model.memoize('Average_Expected_Years_Kept_of_Lithium_Accu_LFP', t)) "
    "* model.memoize('Price_of_Lithium_Accu_LFP', t) "
    "* model.memoize('Real_Discount_Rate', t)) "
    "/ "
    "(pow(1.0 + model.memoize('Real_Discount_Rate', t), "
    "model.memoize('Average_Expected_Years_Kept_of_Lithium_Accu_LFP', t)) - 1.0)"
    ")"
)
Resale_Value_of_Lithium_Accu_LFP.generate_function()

Life_Cycle_Cost_of_Lithium_Accu_LFP = model.converter("Life_Cycle_Cost_of_Lithium_Accu_LFP")
Life_Cycle_Cost_of_Lithium_Accu_LFP.equation = (Price_of_Lithium_Accu_LFP/Average_Expected_Years_Kept_of_Lithium_Accu_LFP) + Operational_Cost_of_Lithium_Accu_LFP - Resale_Value_of_Lithium_Accu_LFP

# -----------------------------------------------------------------------------

Cost_Ownership_of_Lithium_Accu_LFP = model.converter("Cost_Ownership_of_Lithium_Accu_LFP")
Cost_Ownership_of_Lithium_Accu_LFP.equation = (Social_Impact_Cost_of_Lithium_Accu_LFP + Life_Cycle_Cost_of_Lithium_Accu_LFP)/1e+06

Average_Annualized_TCO = model.converter("Average_Annualized_TCO")
Average_Annualized_TCO.equation = (Cost_Ownership_of_Dry_Accu + Cost_Ownership_of_Wet_Accu + Cost_Ownership_of_Lithium_Accu_NMC + Cost_Ownership_of_Lithium_Accu_LFP)/4

Proportion_of_Lithium_Accu_LFP_Annualized_TCO_to_Average_Annualized_TCO = model.converter("Proportion_of_Lithium_Accu_LFP_Annualized_TCO_to_Average_Annualized_TCO")
Proportion_of_Lithium_Accu_LFP_Annualized_TCO_to_Average_Annualized_TCO.equation = Cost_Ownership_of_Lithium_Accu_LFP / Average_Annualized_TCO
...
df_bptk = bptk.run_scenarios(
    ...
    scenarios=["base"],
    equations=["Proportion_of_Lithium_Accu_LFP_Annualized_TCO_to_Average_Annualized_TCO"]
)

# 2. Extract Year and TCO Ratio
year_list = df_bptk.index.tolist()
list_tco_ratio = df_bptk["Proportion_of_Lithium_Accu_LFP_Annualized_TCO_to_Average_Annualized_TCO"].tolist()
